...
class TestBusinessDays < Test::Unit::TestCase
  ...
  context '#+' do
    should 'sum the two BusinessDays and return a new instance' do
      sum = 2.business_days + 1.business_day
      assert_equal sum.days, 3.business_days.days
    end
  end

  context '#-' do
    should 'subtract the other BusinessDays from self and return a new instance' do
      sum = 2.business_days - 1.business_day
      assert_equal sum.days, 1.business_day.days
    end
  end
