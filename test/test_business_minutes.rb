...
describe "business hours" do
  describe "with a standard Time object" do
    it "move to tomorrow if we add 8*60 business minutes" do
      first = Time.parse("Aug 4 2010, 9:35 am")
      later = (8*60).business_minutes.after(first)
      expected = Time.parse("Aug 5 2010, 9:35 am")
      assert_equal expected, later
    end

    it "move to yesterday if we subtract 8*60 business minutes" do
      first = Time.parse("Aug 4 2010, 9:35 am")
      later = (8*60).business_minutes.before(first)
      expected = Time.parse("Aug 3 2010, 9:35 am")
      assert_equal expected, later
    end

    it "take into account a weekend when adding an 60 minutes" do
    ...
    it "take into account a weekend when adding an 60 minutes, using the common interface #since" do
      friday_afternoon = Time.parse("April 9th 2010, 4:50 pm")
      monday_morning = 60.business_minutes.since(friday_afternoon)
      expected = Time.parse("April 12th 2010, 9:50 am")
      assert_equal expected, monday_morning
    end

    it "take into account a weekend when subtracting an 60 minutes" do
    ...
    it "add minutes in the middle of the workday"  do
      monday_morning = Time.parse("April 12th 2010, 9:50 am")
      later = (3*60).business_minutes.after(monday_morning)
    ...
    it "consider any time on a weekend as equivalent to monday morning" do
      ...
      assert_equal 60.business_minutes.before(monday), 60.business_minutes.before(sunday)
    end
    ...
    it "respect work_hours" do
      ...
      assert_equal monday, (9*60).business_minutes.after(friday)
      assert_equal friday, (9*60).business_minutes.before(monday)
    end
    ...
    it "respect work_hours when starting before beginning of workday" do
      ...
      assert_equal monday, (15*60).business_minutes.after(friday)
      assert_equal friday + 1.hour, (15*60).business_minutes.before(monday)
    end
    ...
    it "respect work_hours with some 24 hour days" do
      ...
      assert_equal monday, (24*60).business_minutes.after(friday)
      assert_equal friday, (24*60).business_minutes.before(monday)
    end
    ...
    it "respect work_hours within same day" do
      ...
      assert_equal friday_end, (8*60).business_minutes.after(friday_start)
      assert_equal friday_start + 1.hours, (8*60).business_minutes.before(friday_end)
    end
    ...
    it "respect work_hours with some 24 hour days when starting before beginning of workday" do
      ...
      assert_equal monday, (15*60).business_minutes.after(saturday)
      assert_equal saturday + 3.hours, (15*60).business_minutes.before(monday)
    end
  end
end
